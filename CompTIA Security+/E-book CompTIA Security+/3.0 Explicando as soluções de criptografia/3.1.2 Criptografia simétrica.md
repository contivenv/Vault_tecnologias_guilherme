...
1. Alice e Roberto se reúnem para combinar uma cifra e um valor de chave secreta.
    
    Ambos registram o valor da chave secreta, certificando-se de que ninguém mais possa descobri-lo.
...
As etapas envolvidas são as seguintes: 1.Alice e Bob compartilham uma chave simétrica. 2.Alice criptografa um arquivo usando a chave simétrica, convertendo “HelloWorld” (arquivo) em “rWoeldlolH” (arquivo criptografado). 3.Alice envia o texto cifrado “rWoeldlolH” para Bob. 4.Bob descriptografa o texto cifrado usando a mesma chave simétrica, transformando “rWoeldlolH” em “HelloWorld”.

A criptografia simétrica é muito rápida. Ela é usada para criptografia em massa de grandes quantidades de dados. O principal problema é como Alice e Bob "se encontram" para combinar ou trocar a chave. Se Marta interceptar a chave e obtiver o texto cifrado, a segurança estará comprometida.
