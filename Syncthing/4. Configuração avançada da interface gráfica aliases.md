...
> [!abstract] Resumo Esta nota documenta cada campo da seção **Interface gráfica** em _Ações → Configurações avançadas_ do [[Syncthing - O que é e principais funcionalidades]]. Para cada opção há a função, o valor padrão e **o que acontece se você alterar**.
