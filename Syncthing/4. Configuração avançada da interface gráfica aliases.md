...
title: Syncthing - Configuração avançada da interface gráfica aliases:

- Syncthing GUI avançada
- Syncthing config gui tags:
- syncthing
- documentacao
- seguranca
- gui
- sincronizacao created: 2026-09-23 versao-syncthing: "2.1+" status: rascunho

---

# Syncthing: configuração avançada da interface gráfica

> [!abstract] Resumo Esta nota documenta cada campo da seção **Interface gráfica** em _Ações → Configurações avançadas_ do [[Syncthing]]. Para cada opção há a função, o valor padrão e **o que acontece se você alterar**.
