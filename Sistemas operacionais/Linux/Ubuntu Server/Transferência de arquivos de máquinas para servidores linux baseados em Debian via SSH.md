...
tags:
  ...
  - linux
  - redes
data criação: 2026-01-08T10:10:00
---
```cmd
C:\Users\evillin.ribeiro\Dev\NIA_Desoc
```
...
1. **Usar o PSCP para Transferir Arquivos:**
...
```powershell
scp -r "C:\Users\evillin.ribeiro\Dev\NIA_Desoc" usuario@IP_DO_LINUX:/home/usuario/
```

### Exemplo real:

```powershell
scp -r "C:\Users\evillin.ribeiro\Dev\NIA_Desoc" robo@192.168.2.90:/home/robo/
```

✔ Copia a pasta inteira  
✔ Preserva estrutura  
✔ Seguro (SSH)  
❌ Sem barra de progresso bonita (vida é dura)